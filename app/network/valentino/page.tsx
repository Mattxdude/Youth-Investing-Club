...
export default function ValentinoProfile() {
  return (
            ...
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h1 className="text-3xl font-bold text-gray-900 mb-2">Valentino Curtis</h1>
                  <p className="text-xl text-blue-600 mb-3">Student Investor & Financial Literacy Advocate</p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="border-l-2 border-blue-200 pl-4">
                      <h3 className="font-semibold text-gray-900">Wealth Management Intern</h3>
                      <p className="text-blue-600 text-sm">Golden Wealth Capital • May 2025 - Sept 2025</p>
                      <p className="text-gray-700 mt-2">New York, United States</p>
                    </div>
                    <div className="border-l-2 border-blue-200 pl-4">
                      <h3 className="font-semibold text-gray-900">Active Member</h3>
                      <p className="text-blue-600 text-sm">UCSB Finance Connection • Sept 2024 - Present</p>
                      <p className="text-gray-700 mt-2">Investment Banking Workshop</p>
                    </div>
                    <div className="border-l-2 border-blue-200 pl-4">
                      <h3 className="font-semibold text-gray-900">Active Member</h3>
                      <p className="text-blue-600 text-sm">UCSB Investment Connection • Sept 2024 - Present</p>
                      <p className="text-gray-700 mt-2">PMP</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <a
                      href="https://linkedin.com/in/valentinocurtis"
                      target="_blank"
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">Student Investing</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
